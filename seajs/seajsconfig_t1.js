seajs.config({
    ...
    alias: {
      ...
      "jquery": 	    "jquery/jquery/2.1.0/jquery.js",
	  ...
	  "jqueryvalidate": "jquery/jquery-validate/1.9.0/jquery.validate-mod.js",
	  ...
	  "qsplitter":		"jquery/qsplitter/1.0.0/qsplitter-mod.js",
    },
    map : 
    [
    	[/bui\/(.*).js/,'bui/$1-min.js'],
	...
	debug: true,
	preload:["jquery","seajs-style",'seajs-debug','seajs-log']
});
